...
def scrape_nse_announcements_robust(symbol="AXISBANK", limit=None):
    ...
    chrome_options.binary_location = "/usr/local/bin/google-chrome" # Explicitly set Chrome binary location
    ...
    driver = webdriver.Chrome(service=Service("/app/chromedriver"), options=chrome_options)
